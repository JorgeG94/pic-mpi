...
module pic_mpi_f08
   ...
   use mpi_f08, only: MPI_Comm, MPI_Status, MPI_Request, MPI_COMM_NULL, MPI_COMM_WORLD, &
                      ...
                      MPI_INTEGER, MPI_INTEGER8, MPI_STATUS_IGNORE, MPI_STATUSES_IGNORE, &
                      MPI_REQUEST_NULL, MPI_Comm_rank, &
                      ...
                      MPI_Bcast, MPI_Init, MPI_Initialized, MPI_Init_thread, MPI_Query_thread, MPI_Finalize, &
                      ...
                      MPI_Allreduce, MPI_ADDRESS_KIND, MPI_LOCK_SHARED, &
                      MPI_SUM, MPI_MIN, MPI_MAX, MPI_IN_PLACE, MPI_Wtime
   implicit none
   private
   ...
   public :: MPI_ADDRESS_KIND, MPI_Win, MPI_COMM_WORLD, MPI_UNDEFINED
...
contains
   ...
   function create_win_dp_array(comm, base, win_size) result(win)
      type(comm_t), intent(in) :: comm
      real(dp), target, intent(inout) :: base(:)
