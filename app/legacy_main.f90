program hierarchical_mpi_test_legacy
   ...
   if (world_comm%leader()) then
      print *, "========================================"
      print *, "Testing non-blocking operations (LEGACY)"
      print *, "========================================"
   end if
   ...
   if (world_comm%leader()) then
      print *, "Non-blocking tests completed successfully! (LEGACY)"
      print *, "========================================"
   end if
...
contains
   ...
   subroutine test_nonblocking_basic(comm)
      ...
      if (comm%rank() == 0) then
         ...
         if (recv_data == 84) then
            print *, "PASS: Basic non-blocking test (rank 0) LEGACY"
         else
            print *, "FAIL: Basic non-blocking test (rank 0) LEGACY, expected 84, got ", recv_data
         end if
         ...
         if (recv_data == 42) then
            print *, "PASS: Basic non-blocking test (rank 1) LEGACY"
         else
            print *, "FAIL: Basic non-blocking test (rank 1) LEGACY, expected 42, got ", recv_data
         end if
      end if
   ...
   subroutine test_nonblocking_arrays(comm)
      ...
      if (comm%rank() == 0) then
         ...
         if (test_passed) then
            print *, "PASS: Array non-blocking test (rank 0) LEGACY"
         else
            print *, "FAIL: Array non-blocking test (rank 0) LEGACY"
         ...
         if (test_passed) then
            print *, "PASS: Array non-blocking test (rank 1) LEGACY"
         else
            print *, "FAIL: Array non-blocking test (rank 1) LEGACY"
         end if
      end if
   ...
   subroutine test_nonblocking_waitall(comm)
      ...
      if (comm%rank() == 0) then
         ...
         if (test_passed) then
            print *, "PASS: Waitall test (rank 0) LEGACY"
         else
            print *, "FAIL: Waitall test (rank 0) LEGACY"
         ...
         if (test_passed) then
            print *, "PASS: Waitall test (rank 1) LEGACY"
         else
            print *, "FAIL: Waitall test (rank 1) LEGACY"
         end if
      end if
   ...
   subroutine test_nonblocking_test_function(comm)
      ...
      if (comm%rank() == 0) then
         ...
         if (abs(recv_data - 2.71828_dp) < 1.0e-5_dp) then
            print *, "PASS: Test function (rank 0) LEGACY, iterations: ", iterations
         else
            print *, "FAIL: Test function (rank 0) LEGACY"
         end if
         ...
         if (abs(recv_data - 3.14159_dp) < 1.0e-5_dp) then
            print *, "PASS: Test function (rank 1) LEGACY"
         else
            print *, "FAIL: Test function (rank 1) LEGACY"
         end if
      end if
